...
export const translations = {
  ...
  geomBackAll:       { BN: 'সকল অধ্যায়-এ ফিরে যান',      EN: 'Back to All Chapters' },
  geomBackChapter:   { BN: '-এ ফিরে যান',                  EN: 'Back to' },
  geomComingSoon:    { BN: 'শীঘ্রই আসছে!',                  EN: 'Coming Soon!' },
  geomComingSoonDesc:{ BN: 'এই চ্যাপ্টার এর উপপাদ্যগুলো বর্তমানে তৈরি করা হচ্ছে।', EN: 'Theorems for this chapter are being prepared. Please check back soon.' },
